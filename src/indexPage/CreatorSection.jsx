import img from '../assets/pictureimage.jpg';
    ...
    <section id='Creator' className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 text-gray-800">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 max-w-md mx-auto hover:shadow-xl transition">
          ...
          />
          <h3 className="text-2xl font-semibold text-gray-800">Mehak Garg</h3>
          <p className="text-green-600 mb-2">Full Stack Developer</p>
          <p className="text-gray-600 text-sm">
            A final year B.E student with a passion for building impactful solutions. CureConnect is a step towards making healthcare more accessible.
          </p>
        </div>
      </div>
    </section>
